...
public class RegTileEntitys {
    ...
    public static final RegistryObject<TileEntityType<TileEntityStorage>> DRAWERS_STORAGE_TE = register("drawers_te", TileEntityStorage::new, () -> new Block[]{RegBlocks.BIOLAB_TABLE4.get(), RegBlocks.BIOLAB_TABLE.get(), RegBlocks.CHEMLAB_TABLE.get()});
