package ru.tesmio.soviet.blocks.affinage_factory;
...
public class AffinageItemHandler extends ItemStackHandler {

    public AffinageItemHandler(int size, ItemStack... stacks) {
        super(size);
