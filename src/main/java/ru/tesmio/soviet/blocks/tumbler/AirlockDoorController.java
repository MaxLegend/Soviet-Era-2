...
import ru.tesmio.soviet.blocks.decorative.devices.Turnstile;
...
public class AirlockDoorController extends BlockSideCustomModel {
    ...
    @Override
    public ItemStack[] getItemsDrop(PlayerEntity player) {
        return new ItemStack[]{
                new ItemStack(RegBlocks.SILVER_CIRCUIT.get(), player.world.rand.nextInt(4)),
                new ItemStack(RegBlocks.GOLD_CIRCUIT.get(), player.world.rand.nextInt(3)),
                new ItemStack(RegBlocks.NETHERITE_CIRCUIT.get(), player.world.rand.nextInt(2)),
                new ItemStack(RegBlocks.PLATINUM_CIRCUIT.get(), player.world.rand.nextInt(1))
        };
    }
