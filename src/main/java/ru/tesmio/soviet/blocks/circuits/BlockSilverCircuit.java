            ...
            if (worldIn instanceof ServerWorld) {
                switch (state.get(DISSECTION)) {
                    case 0:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.ORANGE_CONDENSER.get(), 19));
                    ...
                    case 3:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DARK_YELLOW_TRANSISTOR.get(), 7));
                    ...
                    case 4:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.BLACK_MICRO.get(), 39));
                    ...
                    case 5:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DARK_YELLOW_MICRO.get(), 13));
                    ...
                    case 6:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DARK_BLUE_MICRO.get(), 3));
                    ...
                    case 7:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.YELLOW_JACK.get(), 1));
