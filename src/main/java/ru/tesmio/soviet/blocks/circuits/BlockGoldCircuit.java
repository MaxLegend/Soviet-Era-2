package ru.tesmio.soviet.blocks.circuits;
...
import ru.tesmio.soviet.blocks.baseblock.BlockCircuit;
            ...
            if (worldIn instanceof ServerWorld) {
                switch (state.get(DISSECTION)) {
                    case 0:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.BLUE_CONDENSER.get(), 18));
                    ...
                    case 1:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.GREEN_CONDENSER.get(), 21));
                    ...
                    case 2:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.YELLOW_CONDENSER.get(), 5));
                    ...
                    case 3:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DIODE_BLACK.get(), 5));
                        player.getHeldItemMainhand().damageItem(5, player, (p) -> p.sendBreakAnimation(handIn));
                        return ActionResultType.SUCCESS;
                    case 4:
                        worldIn.setBlockState(pos, state.with(DISSECTION, 5));
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.BLACK_MICRO.get(), 31));
                    ...
                    case 5:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DARK_YELLOW_MICRO.get(), 6));
                    ...
                    case 6:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DARK_YELLOW_TRANSISTOR.get(), 6));
                        player.getHeldItemMainhand().damageItem(6, player, (p) -> p.sendBreakAnimation(handIn));
                        return ActionResultType.SUCCESS;
                    case 7:
                        worldIn.setBlockState(pos, state.with(DISSECTION, 8));
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DARK_BLUE_MICRO.get(), 18));
                        player.getHeldItemMainhand().damageItem(18, player, (p) -> p.sendBreakAnimation(handIn));
                        return ActionResultType.SUCCESS;
                    case 8:
                        worldIn.setBlockState(pos, RegBlocks.GOLD_CIRCUIT_EMPTY.get().getDefaultState());
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.BLUE_JACK.get(), 1));
