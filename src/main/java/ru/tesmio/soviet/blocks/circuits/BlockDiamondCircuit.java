            ...
            if (worldIn instanceof ServerWorld) {
                switch (state.get(DISSECTION)) {
                    case 0:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.ORANGE_CONDENSER.get(), 13));
                    ...
                    case 1:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.GREEN_CONDENSER.get(), 20));
                    ...
                    case 2:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.YELLOW_CONDENSER.get(), 31));
                    ...
                    case 3:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.BLACK_MICRO.get(), 15));
                    ...
                    case 4:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DARK_YELLOW_MICRO.get(), 23));
                    ...
                    case 5:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DARK_GRAY_TRANSISTOR.get(), 8));
                    ...
                    case 6:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DARK_BLUE_MICRO.get(), 13));
