            ...
            if (worldIn instanceof ServerWorld) {
                switch (state.get(DISSECTION)) {
                    case 0:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.GREEN_CONDENSER.get(), 50));
                    ...
                    case 1:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DIODE_GRAY.get(), 8));
                    ...
                    case 2:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DIODE_BLACK.get(), 43));
                    ...
                    case 3:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DARK_YELLOW_MICRO.get(), 60));
                    ...
                    case 4:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DARK_BLUE_MICRO.get(), 10));
