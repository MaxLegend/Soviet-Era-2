            ...
            if (worldIn instanceof ServerWorld) {
                switch (state.get(DISSECTION)) {
                    case 0:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.GREEN_CONDENSER.get(), 24));
                    ...
                    case 1:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.YELLOW_CONDENSER.get(), 30));
                    ...
                    case 2:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.BLUE_CONDENSER.get(), 20));
                    ...
                    case 3:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DIODE_BLACK.get(), 19));
                    ...
                    case 4:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DIODE_GRAY.get(), 2));
                    ...
                    case 5:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DARK_YELLOW_MICRO.get(), 34));
                    ...
                    case 6:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DARK_BLUE_MICRO.get(), 15));
                    ...
                    case 7:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.GREEN_JACK.get(), 2));
                        player.getHeldItemMainhand().damageItem(2, player, (p) -> p.sendBreakAnimation(handIn));
                        return ActionResultType.SUCCESS;
                    case 8:
                        worldIn.setBlockState(pos, RegBlocks.NETHERITE_CIRCUIT_EMPTY.get().getDefaultState());
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.YELLOW_JACK.get(), 2));
                        player.getHeldItemMainhand().damageItem(2, player, (p) -> p.sendBreakAnimation(handIn));
                        return ActionResultType.SUCCESS;
                }
