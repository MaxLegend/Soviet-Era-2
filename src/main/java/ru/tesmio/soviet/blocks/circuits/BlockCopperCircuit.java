            ...
            if (!worldIn.isRemote) {
                switch (state.get(DISSECTION)) {
                    case 0:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.ORANGE_CONDENSER.get(), 20));
                    ...
                    case 1:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.GREEN_CONDENSER.get(), 2));
                    ...
                    case 2:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DARK_YELLOW_TRANSISTOR.get(), 5));
                    ...
                    case 3:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DARK_RED_MICRO.get(), 9));
                    ...
                    case 4:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.BLACK_MICRO.get(), 36));
                    ...
                    case 5:
                        ...
                        state.getBlock();
                        spawnAsEntity(worldIn, pos, new ItemStack(RegItems.DARK_YELLOW_MICRO.get(), 1));
