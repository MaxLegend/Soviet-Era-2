            ...
            switch (s.get(FACING)) {
                case NORTH:
                    if (eastS.getBlock() instanceof ContactWireAngle) {
                        s = s.with(RIGHT, true);
                    } else if (eastS.getBlock() instanceof ContactWire) {
                    ...
                    if (westS.getBlock() instanceof ContactWireAngle) {
                        s = s.with(RIGHT, true);
                    } else if (westS.getBlock() instanceof ContactWire) {
                ...
                case EAST:
                    if (northS.getBlock() instanceof ContactWireAngle) {
                        s = s.with(LEFT, true);
                    } else if (northS.getBlock() instanceof ContactWire) {
                    ...
                    if (southS.getBlock() instanceof ContactWireAngle) {
                        s = s.with(RIGHT, true);
                    } else if (southS.getBlock() instanceof ContactWire) {
