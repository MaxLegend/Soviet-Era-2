...
public class Turnstile extends BlockSideCustomModel {
    private static final VoxelShape[] SHAPES = new VoxelShape[]{
            ...
            VoxelShapes.or(
                    VoxelShapeUtil.shapeRot180(VoxelShapeUtil.shapeRotCCW90(Block.makeCuboidShape(0D, 0D, 4D, 5D, 1D, 12D))),
                    VoxelShapeUtil.shapeRot180(VoxelShapeUtil.shapeRotCCW90(Block.makeCuboidShape(0D, 0D, 6D, 3D, 10D, 10D))),
                    VoxelShapeUtil.shapeRot180(VoxelShapeUtil.shapeRotCCW90(Block.makeCuboidShape(0D, 10D, 4D, 4D, 13D, 12D))),
                    VoxelShapeUtil.shapeRot180(VoxelShapeUtil.shapeRotCCW90(Block.makeCuboidShape(0D, 13D, 5D, 6D, 16D, 11D))),
                    //opened part
                    VoxelShapeUtil.shapeRot180(VoxelShapeUtil.shapeRotCCW90(Block.makeCuboidShape(4D, 1.8D, 7.65D, 5.8D, 12.8D, 8.37D)))),
            VoxelShapes.or(
                    VoxelShapeUtil.shapeRot180(VoxelShapeUtil.shapeRotCCW90(Block.makeCuboidShape(0D, 0D, 4D, 5D, 1D, 12D))),
                    VoxelShapeUtil.shapeRot180(VoxelShapeUtil.shapeRotCCW90(Block.makeCuboidShape(0D, 0D, 6D, 3D, 10D, 10D))),
                    VoxelShapeUtil.shapeRot180(VoxelShapeUtil.shapeRotCCW90(Block.makeCuboidShape(0D, 10D, 4D, 4D, 13D, 12D))),
                    VoxelShapeUtil.shapeRot180(VoxelShapeUtil.shapeRotCCW90(Block.makeCuboidShape(0D, 13D, 5D, 6D, 16D, 11D))),
                    VoxelShapeUtil.shapeRot180(VoxelShapeUtil.shapeRotCCW90(Block.makeCuboidShape(0D, 11D, 7.65D, 15.25D, 12.8D, 8.37D)))),
    ...
    public ActionResultType onBlockActivated(BlockState s, World w, BlockPos p, PlayerEntity pl, Hand hand, BlockRayTraceResult hit) {
        if (s.get(STATUS) == EnumStatus.CLOSE) {
            w.playSound(null, p, SovietSounds.RUSTY_LEVER.get(), SoundCategory.BLOCKS, 0.10f, 1f);
