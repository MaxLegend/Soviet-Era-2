            ...
            switch (s.get(FACING)) {
                case SOUTH:
                    if (southPos.getBlock() == validBlock()) {
                        if (southPos.get(FACING) == Direction.EAST)
                            return state.with(ENUM_CONNECT, EnumConnent.CORNER_LEFT);
                        if (southPos.get(FACING) == Direction.WEST)
                            return state.with(ENUM_CONNECT, EnumConnent.CORNER_RIGHT);
                    } else {
                ...
                case WEST:
                    if (westPos.getBlock() == validBlock()) {
                        if (westPos.get(ENUM_CONNECT) == EnumConnent.NOT_CONNECT) {
                            if (westPos.get(FACING) == Direction.NORTH)
                                return state.with(ENUM_CONNECT, EnumConnent.CORNER_RIGHT);
                            if (westPos.get(FACING) == Direction.SOUTH)
                                return state.with(ENUM_CONNECT, EnumConnent.CORNER_LEFT);
                        }
                    } else {
                        return state.with(ENUM_CONNECT, EnumConnent.NOT_CONNECT).with(FACING, s.get(FACING));
                ...
                case EAST:
                    if (eastPos.getBlock() == validBlock()) {
                        if (eastPos.get(FACING) == Direction.NORTH)
                            return state.with(ENUM_CONNECT, EnumConnent.CORNER_LEFT);
                        if (eastPos.get(FACING) == Direction.SOUTH)
                            return state.with(ENUM_CONNECT, EnumConnent.CORNER_RIGHT);
                    } else {
                        return state.with(ENUM_CONNECT, EnumConnent.NOT_CONNECT).with(FACING, s.get(FACING));
                    }
                ...
                case NORTH:
                    if (northPos.getBlock() == validBlock()) {
                        if (northPos.get(FACING) == Direction.WEST)
                            return state.with(ENUM_CONNECT, EnumConnent.CORNER_LEFT);
                        if (northPos.get(FACING) == Direction.EAST)
                            return state.with(ENUM_CONNECT, EnumConnent.CORNER_RIGHT);
                    } else {
                        return state.with(ENUM_CONNECT, EnumConnent.NOT_CONNECT).with(FACING, s.get(FACING));
                    }
