package ru.tesmio.soviet.blocks.crusher;
...
public class CrusherTileEntity extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
    ...
    private final CrusherItemHandler inventory;

    public CrusherTileEntity(TileEntityType<?> tileEntityTypeIn) {
        super(tileEntityTypeIn);

        this.inventory = new CrusherItemHandler(2);
    }
    ...
    private ITextComponent getDefaultName() {
        return new TranslationTextComponent("container." + Core.MODID + ".crusher");
    }
