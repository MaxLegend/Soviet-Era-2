...
import ru.tesmio.soviet.blocks.baseblock.*;
import ru.tesmio.soviet.blocks.baseblock.subtype.*;
import ru.tesmio.soviet.blocks.circuits.*;
import ru.tesmio.soviet.blocks.crusher.BlockCrusher;
import ru.tesmio.soviet.blocks.decorative.const_panel.PanelBlockCorner;
import ru.tesmio.soviet.blocks.decorative.const_panel.PanelBlockSide;
import ru.tesmio.soviet.blocks.decorative.devices.*;
import ru.tesmio.soviet.blocks.decorative.lamp.*;
import ru.tesmio.soviet.blocks.decorative.props.*;
import ru.tesmio.soviet.blocks.decorative.props.chairs.BiolabChair;
import ru.tesmio.soviet.blocks.decorative.props.chairs.Chair;
import ru.tesmio.soviet.blocks.decorative.props.chairs.DspChair;
import ru.tesmio.soviet.blocks.decorative.props.chairs.PurpleChair;
import ru.tesmio.soviet.blocks.decorative.props.stillage.StillageBlock;
import ru.tesmio.soviet.blocks.decorative.props.tables.DspTable;
import ru.tesmio.soviet.blocks.decorative.props.tables.PurpleTable;
import ru.tesmio.soviet.blocks.decorative.slabs.BaseSlab;
import ru.tesmio.soviet.blocks.decorative.stairs.BaseStairs;
import ru.tesmio.soviet.blocks.decorative.windows.AlumFrame;
import ru.tesmio.soviet.blocks.decorative.windows.AlumWindow;
import ru.tesmio.soviet.blocks.decorative.windows.FactoryWindow;
import ru.tesmio.soviet.blocks.decorative.windows.ModernWindow;
import ru.tesmio.soviet.blocks.diesel_generator.DieselElectroGenerator;
import ru.tesmio.soviet.blocks.diesel_generator.DieselGenerator;
import ru.tesmio.soviet.blocks.diesel_generator.DieselTank;
import ru.tesmio.soviet.blocks.doors.*;
import ru.tesmio.soviet.blocks.fences.*;
import ru.tesmio.soviet.blocks.rasty_frame.RastyFrameBlock;
import ru.tesmio.soviet.blocks.storage.desc_drawers.LinearTableDrawers;
import ru.tesmio.soviet.blocks.storage.dsp_tump.DspTumbBlock;
import ru.tesmio.soviet.blocks.storage.kitchen_table.KitchenTable;
import ru.tesmio.soviet.blocks.storage.safe.BlockSafe;
import ru.tesmio.soviet.blocks.tumbler.AirlockDoorController;
import ru.tesmio.soviet.blocks.tumbler.ElectroFenceTumbler;
import ru.tesmio.soviet.blocks.tumbler.RustyTumbler;
...
public class RegBlocks {
    ...
    public static RegistryObject<Block> ALUM_FRAMES, ALUM_FRAMES_EMPTY, ALUM_WINDOW, ALUM_WINDOW_EMPTY, MODERN_WINDOW, MODERN_WINDOW_EMPTY, MODERN_WINDOW_LEAF, MODERN_WINDOW_LEAF_EMPTY, WOOD_WINDOW, WOOD_WINDOW_EMPTY, WOOD_WINDOW_LEAF, WOOD_WINDOW_LEAF_EMPTY, FACTORY_WINDOW, FACTORY_WINDOW_EMPTY;
    ...
    public static RegistryObject<Block> DRY_CAB, MAGNET_MIXER, MIXER, LAB_STOVE, SLATE, BIO_STILLAGE, CHAIN, LEAD_WALL, THIN_LEAD_WALL, CIRCLE_FILTER, HALF_CIRCLE_GRID, DIAGONAL_GRID, FULL_DIAGONAL_GRID, FULL_DIAGONAL_GRID_INVERT, REST_FILTER, WINDPROOF_BETON_GRAY, WINDPROOF_BETON_GREEN, WINDPROOF_BETON_RED, WINDPROOF_BETON_ORANGE, WINDPROOF_BETON_YELLOW, WINDPROOF_BETON_BLUE, WINDPROOF_BETON_BEIGE, WINDPROOF_BETON_BEIGE2, WINDPROOF_BETON_WHITE;
    ...
    public static void init() {
        ...
        for (String symbol : Symbols.SYMBOLS_NAME) {
            registerBlockWithModel("outerdeco/symbols/" + symbol, () -> new SymbolBlock(getP(Material.IRON, 0.4f, 0.6f, null, 1, SoundType.METAL, false, true), 1F), Core.ItemGroups.TAB_SYMBOLS);
        }
        ...
        BLOCK_MOSS = registerBlockWithModel("outerdeco/block_moss", BlockMoss::new, Core.ItemGroups.TAB_OUTER_DECO);
        BLOCK_MOSS_FULL = registerBlockWithModel("outerdeco/block_moss_full", BlockMoss::new, Core.ItemGroups.TAB_OUTER_DECO);
        BLOCK_MOULD = registerBlockWithModel("outerdeco/block_mould", BlockMoss::new, Core.ItemGroups.TAB_OUTER_DECO);
        ...
        BIO_STILLAGE = registerBlockWithModel("innerdeco/bio_stillage", () -> new BioStillage(getP(Material.WOOD, 0.9f, 1.1f, ToolType.AXE, 0, SoundType.GLASS, true, true)) {
        }, Core.ItemGroups.TAB_INNER_DECO);
        CHEMLAB_TABLE = registerBlockWithModel("innerdeco/chemlab_table", () -> new LinearTableDrawers(FURNITURE_PROPERTIES) {
        }, Core.ItemGroups.TAB_INNER_DECO);
        CHEMLAB_TABLE_CASE = registerBlockWithModel("innerdeco/chemlab_table_up", () -> new LinearTable(FURNITURE_PROPERTIES) {
        }, Core.ItemGroups.TAB_INNER_DECO);
        BIOLAB_TABLE = registerBlockWithModel("innerdeco/biolab_table", () -> new LinearTableDrawers(FURNITURE_PROPERTIES) {
        }, Core.ItemGroups.TAB_INNER_DECO);
        BIOLAB_TABLE_CASE = registerBlockWithModel("innerdeco/biolab_table_up", () -> new LinearTable(FURNITURE_PROPERTIES) {
        }, Core.ItemGroups.TAB_INNER_DECO);
        BIOLAB_TABLE2 = registerBlockWithModel("innerdeco/biolab_table2", () -> new LinearTable(FURNITURE_PROPERTIES) {
        }, Core.ItemGroups.TAB_INNER_DECO);
        BIOLAB_TABLE3 = registerBlockWithModel("innerdeco/biolab_table3", () -> new LinearTable(FURNITURE_PROPERTIES) {
        }, Core.ItemGroups.TAB_INNER_DECO);
        BIOLAB_TABLE4 = registerBlockWithModel("innerdeco/biolab_table4", () -> new LinearTableDrawers(FURNITURE_PROPERTIES) {
        }, Core.ItemGroups.TAB_INNER_DECO);
        PURPLE_TABLE = registerBlockWithModel("innerdeco/furniture/purple_table", () -> new PurpleTable(FURNITURE_PROPERTIES) {
        }, Core.ItemGroups.TAB_INNER_DECO);
        PURPLE_CHAIR = registerBlockWithModel("innerdeco/furniture/purple_chair", () -> new PurpleChair(CLOTH_PROPERTIES, 0.5F) {
        }, Core.ItemGroups.TAB_INNER_DECO);
        PINK_CHAIR = registerBlockWithModel("innerdeco/furniture/pink_chair", () -> new Chair(CLOTH_PROPERTIES, 0.5F) {
        }, Core.ItemGroups.TAB_INNER_DECO);
        ...
        MOTION_SENSOR = registerBlockWithModel("innerdeco/devices/motion_sensor", () -> new EntitySensor(DEVICES_PROPERTIES) {
        }, Core.ItemGroups.TAB_OUTER_DECO);
        TURNSTILE = registerBlockWithModel("innerdeco/devices/turnstile_off", () -> new Turnstile(getP(Material.IRON, 1.0f, 1.6f, null, 0, SoundType.METAL, false, true)) {
        }, Core.ItemGroups.TAB_INNER_DECO);
        ...
        SLATE = registerBlockWithModel("innerdeco/slate", () -> new SlateBlock(getP(Material.ROCK, 0.8f, 1.1f, ToolType.PICKAXE, 0, SoundType.STONE, true, true)) {
        }, Core.ItemGroups.TAB_OUTER_DECO);
        CHAIN = registerBlockWithModel("innerdeco/chain", () -> new Chain(getP(Material.IRON, 0.3f, 0.4f, ToolType.PICKAXE, 0, SoundType.METAL, true, true)) {
        }, Core.ItemGroups.TAB_INNER_DECO);
        LEAD_WALL = registerBlockWithModel("innerdeco/lead_wall", () -> new LeadWall(getP(Material.IRON, 2.8f, 8.6f, ToolType.PICKAXE, 2, SoundType.STONE, true, true), 1F) {
        }, Core.ItemGroups.TAB_INNER_DECO);
        THIN_LEAD_WALL = registerBlockWithModel("innerdeco/thin_lead_wall", () -> new LeadWall(getP(Material.IRON, 1.6f, 6.6f, ToolType.PICKAXE, 2, SoundType.STONE, true, true), 1F) {
        }, Core.ItemGroups.TAB_INNER_DECO);
        ...
        //trim_stone
        TRIM_TILE_1 = registerBlock("structural/trim_tile_1", TilledBlock::new, Core.ItemGroups.TAB_MAIN);
        TRIM_TILE_1_BR = registerBlock("structural/trim_tile_1_br", TilledBlock::new, Core.ItemGroups.TAB_MAIN);
        ...
        TRIM_TILE_RED = registerBlock("structural/trim_tile_red", TilledBlock::new, Core.ItemGroups.TAB_MAIN);
        TRIM_TILE_BLUE = registerBlock("structural/trim_tile_blue", TilledBlock::new, Core.ItemGroups.TAB_MAIN);
        ...
        CONTAINMENT_BLOCK = registerBlock("structural/containment_block", MetalBlock::new, Core.ItemGroups.TAB_MAIN);
        TRIM_METAL_1 = registerBlock("structural/trim_metal_1", MetalBlock::new, Core.ItemGroups.TAB_MAIN);
        TRIM_METAL_2 = registerBlock("structural/trim_metal_2", MetalBlock::new, Core.ItemGroups.TAB_MAIN);
        LEADCERAMIC_TILE = registerBlock("structural/leadceramic_tile", TilledBlock::new, Core.ItemGroups.TAB_MAIN);
        RUSTYMETAL_BLOCK = registerBlock("structural/rusty_block", MetalBlock::new, Core.ItemGroups.TAB_MAIN);
        ...
        //ceramic_glass
        CERAMIC_GLASS_BLUE = registerBlock("structural/ceramic_glass_blue", GlassBlock::new, Core.ItemGroups.TAB_MAIN);
        CERAMIC_GLASS_GREEN = registerBlock("structural/ceramic_glass_green", GlassBlock::new, Core.ItemGroups.TAB_MAIN);
        CERAMIC_GLASS_BROWN = registerBlock("structural/ceramic_glass_brown", GlassBlock::new, Core.ItemGroups.TAB_MAIN);

        //linos
        LINO_1 = registerBlock("lino/lino1", LinoBlock::new, Core.ItemGroups.TAB_MAIN);
        LINO_2 = registerBlock("lino/lino2", LinoBlock::new, Core.ItemGroups.TAB_MAIN);
        LINO_3 = registerBlock("lino/lino3", LinoBlock::new, Core.ItemGroups.TAB_MAIN);
        LINO_4 = registerBlock("lino/lino4", LinoBlock::new, Core.ItemGroups.TAB_MAIN);
        LINO_5 = registerBlock("lino/lino5", LinoBlock::new, Core.ItemGroups.TAB_MAIN);
        LINO_6 = registerBlock("lino/lino6", LinoBlock::new, Core.ItemGroups.TAB_MAIN);
        LINO_7 = registerBlock("lino/lino7", LinoBlock::new, Core.ItemGroups.TAB_MAIN);
        LINO_8 = registerBlock("lino/lino8", LinoBlock::new, Core.ItemGroups.TAB_MAIN);
        ...
        //panels
        PANEL_CONCRETE_CORNER = registerNDBlock("structural/panel_concrete_corner", PanelBlockCorner::new, Core.ItemGroups.TAB_MAIN);
        PANEL_CONCRETE_SIDE = registerNDBlock("structural/panel_concrete_side", PanelBlockSide::new, Core.ItemGroups.TAB_MAIN);
        ...
        PANEL_CONCRETE_YELLOW_CORNER = registerNDBlock("structural/panel_concrete_yellow_corner", PanelBlockCorner::new, Core.ItemGroups.TAB_MAIN);
        PANEL_CONCRETE_YELLOW_SIDE = registerNDBlock("structural/panel_concrete_yellow_side", PanelBlockSide::new, Core.ItemGroups.TAB_MAIN);
        ...
        PANEL_TILE_CORNER = registerNDBlock("structural/panel_tile_corner", PanelBlockCorner::new, Core.ItemGroups.TAB_MAIN);
        PANEL_TILE_SIDE = registerNDBlock("structural/panel_tile_side", PanelBlockSide::new, Core.ItemGroups.TAB_MAIN);
        ...
        //bricks
        RED_BRICKS_BR = registerBlock("brick/red_bricks_br", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        RED_BRICKS = registerBlock("brick/red_bricks", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        SHORT_BRICKS = registerBlock("brick/short_bricks", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        BRICKS_BR = registerBlock("brick/soviet_bricks_br", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        BRICKS = registerBlock("brick/soviet_bricks", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        BRICKS_WITH_WHITE = registerBlock("brick/soviet_bricks_with_white", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        WALL_BRICKS = registerBlock("brick/light_bricks2", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        LIGHT_BRICKS = registerBlock("brick/light_bricks", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        WALL_BRICKS_BR = registerBlock("brick/light_bricks2_br", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        LIGHT_BRICKS_BR = registerBlock("brick/light_bricks_br", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        YELLOW_BRICKS_1_BR = registerBlock("brick/yellow_bricks_1_br", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        YELLOW_BRICKS_1 = registerBlock("brick/yellow_bricks_1", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        YELLOW_BRICKS_2_BR = registerBlock("brick/yellow_bricks_2_br", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        YELLOW_BRICKS_2 = registerBlock("brick/yellow_bricks_2", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        YELLOW_BRICKS_3_BR = registerBlock("brick/yellow_bricks_3_br", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        YELLOW_BRICKS_3 = registerBlock("brick/yellow_bricks_3", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        WHITE_BRICKS = registerBlock("brick/white_bricks", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        WHITE_BRICKS_BR = registerBlock("brick/white_bricks_br", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
        SMALL_BRICKS = registerBlock("brick/small_bricks", BrickBlock::new, Core.ItemGroups.TAB_MAIN);
